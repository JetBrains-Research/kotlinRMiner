...
/**
 * Handler object that works in conjunction with {@link GitHistoryKotlinRMinerApi}.
 */
public abstract class RefactoringHandler {

    /**
     * Indicates commits that should be ignored.
     * You may override this method to implement a custom logic.
     *
