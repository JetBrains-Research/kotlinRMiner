...
/*     TODO:   if (statement1.getTernaryOperatorExpressions().isEmpty() && !statement2.getTernaryOperatorExpressions()
.isEmpty()) {
    ...
    private boolean validStatementForConcatComparison(AbstractCodeFragment statement1,
        ...
        if (variableDeclarations1.size() == variableDeclarations2.size()) {
            ...
            if (variableDeclarations1.size() > 0 && variableDeclarations2.size() == 0 && statement2.getString().startsWith(
                    "return ")) {
                return true;
            } else if (variableDeclarations1.size() == 0 && variableDeclarations2.size() > 0 && statement1.getString().startsWith(
                    "return ")) {
                return true;
            }
        }
        ...
        if (string1.contains("=") && string1.endsWith(";\n") && string2.startsWith("return ") && string2.endsWith(
            ...
            for (Replacement replacement : replacementInfo.getReplacements()) {
                if (replacement.getType().equals(ReplacementType.TYPE)) {
                    ...
                    if (string1.contains("new " + replacement.getBefore() + "(") && string2.contains(
                            "new " + replacement.getAfter() + "("))
